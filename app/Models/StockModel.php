...
class StockModel extends Model
{
    ...
    public function __construct()
    {
        ...
        $sql = "
        CREATE OR REPLACE VIEW public.stock_detail_view
 AS
...
";
    ...
    function insert_stock($trans_type, $doc_number, $item_code, $lot_no, $rack, $pallet, $inv_onhand, $inv_alloc, $username = "unknown"){
        log_message('info', " > inserting stock data");
        ...
        log_message('info', " > calculating stock data qty");
        ...
        log_message('info', " > insert palletizing data history");
