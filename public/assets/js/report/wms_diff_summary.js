$(document).ready(function() {
    ...
    // - activate datatable - //
    var table = $('#table_wms_diff_summary').DataTable( {
        ajax: {
            url: baseUrl + '/api?cmd=get_wms_diff_summary',
            "data": function(d) {
        ...
        "columnDefs": [
            {
                "targets": [5,6,7], // Assuming you want to format the first column
    ...
    $('#btn_search').click(function(){
        ...
        if($('#period').val() == ""){
            ...
            table.search('').draw();
            // - get total wms summary qty - //
            get_total_wms_summary_qty();
        }
...
// - get total summary qty - //
function get_total_wms_summary_qty(){
    var period = $('#period').val();
    var plant = $('#plant').val();
