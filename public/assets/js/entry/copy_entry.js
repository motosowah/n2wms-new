...
function copyEntry(){
    if(confirm("Save this entry?")){
        ...
        json_data['flags'] = "modified"; 
        json_data['reference'] = val_entry_id;     // use original entry id as reference //
        json_data['id'] = "1";
